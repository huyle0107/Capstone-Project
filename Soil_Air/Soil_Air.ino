...
void read_data_sensor(){
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    air_TEMP = int16_t((receivedData[3] << 8 | receivedData[4])) / 10.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    Serial.println();
    Serial.print("AIR CO =");
    air_CO = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    air_CO2 = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    air_SO2 = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    air_NO2 = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    Serial.println();
    Serial.print("AIR O3 =");
    air_O3 = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    air_PM10 = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    air_PM25 = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    Serial.println();
    Serial.print("LUX =");
    air_LUX = int32_t(receivedData[3] << 24 | receivedData[4] << 16| receivedData[5] << 8 | receivedData[6]) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    Serial.println();
    Serial.print("Soil_N =");
    soil_N = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
    Serial.println(data.floatToString(soil_N));

    Serial.print("Soil_P =");
    soil_P = int16_t((receivedData[5] << 8 | receivedData[6])) / 1.0;
    Serial.println(data.floatToString(soil_P));

    Serial.print("Soil_K =");
    soil_K = int16_t((receivedData[7] << 8 | receivedData[8])) / 1.0;
  ...
  if (Serial2.available()) {    // If the serial port receives a message.
    ...
    soil_EC = int16_t((receivedData[3] << 8 | receivedData[4])) / 1.0;
    Serial.println(data.floatToString(soil_EC));
  }
}

void turn_on_off_relay(int logic){
  if (logic == 1)
  {
...
>>>>>>> bdde868464b9328e72e5a296153fba0972409971
