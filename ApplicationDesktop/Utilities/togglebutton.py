...
class ToggleButton:
    ...
    def __init__(self, win):
        ...
        try:
            ...
            self.on  = ImageTk.PhotoImage(Image.open("/home/pi/Desktop/MDT-128/Capstone-Project/ApplicationDesktop/Images/on_button_m.png").resize((54, 32), Image.LANCZOS))
            self.off = ImageTk.PhotoImage(Image.open("/home/pi/Desktop/MDT-128/Capstone-Project/ApplicationDesktop/Images/off_button_m.png").resize((54, 32), Image.LANCZOS))
    ...
    def button_place(self, x_coor, y_coor, wid_coor, height_coor):
        self.on_button.place(relx = x_coor, rely = y_coor, relwidth = wid_coor, relheight = height_coor, anchor="n")
